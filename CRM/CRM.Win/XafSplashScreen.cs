...
namespace CRM.Win {
    public partial class XafSplashScreen : SplashScreen {
		private void LoadBlankLogo() {
            ...
            string blankLogoResourceName = assembly.GetName().Name + ".Images.Concloud1.png";
        ...
        public XafSplashScreen() {
            InitializeComponent();
			LoadBlankLogo();
            this.labelCopyright.Text = "版权 © " + DateTime.Now.Year.ToString() + " Concloud" +  System.Environment.NewLine + "版权所有。";
